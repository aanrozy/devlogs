...
>
    ...
    <div class="container flex items-center justify-between relative z-10">
        ...
        <a
            href="/"
            class="text-2xl font-black tracking-widest text-white z-[110] uppercase font-['Playfair_Display']"
        >
            PORTO<span class="text-yellow-200">.</span>
        </a>
        ...
        <div class="flex items-center space-x-3 md:space-x-5 z-[110]">
            <a
                href="/account"
                class="hidden md:flex items-center gap-2 text-sm font-medium text-white/70 hover:text-yellow-200 transition-colors"
            >
                <User size={18} />
                Guest
            </a>
    ...
    {#if isMenuOpen}
        ...
        >
            <nav class="flex flex-col space-y-6">
                ...
                <div class="pt-6">
                    <Button
                        class="w-full h-12 text-lg rounded-2xl shadow-lg bg-yellow-200 text-black hover:bg-[#F3E5AB]"
                    >
                        Account
                    </Button>
                </div>
            ...
            <div class="mt-auto pb-12 text-center">
                <p class="text-white/40 text-sm">
                    © 2026 muzia.online. All rights reserved.
                </p>
            </div>
        </div>
    {/if}
